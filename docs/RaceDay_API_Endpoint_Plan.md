...
\- Admin: manages users and system-level information.

\- Organiser: manages events, categories and event enrolments.

\- Participant: manages their profile and enrolments.
